# nvim-treesitter-queries-fennel

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-fennel/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-fennel/actions/workflows/validate.yml)

Neovim tree-sitter queries for **fennel**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-fennel",
...
- [ ] Changes are scoped to `fennel` — do not include files for other languages
